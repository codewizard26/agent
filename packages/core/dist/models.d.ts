...
export declare const RANK_MODEL = "gpt-5";
/** Cheap structured extraction: resumes, HN comments, Bluesky posts, form fields. */
export declare const UTILITY_MODEL = "gpt-5-mini";
/**
 ...
 */
export declare const CLAUDE_RANK_MODEL = "claude-sonnet-5";
/** Haiku for the per-item extractions — HN comments and Bluesky posts run hundreds deep. */
export declare const CLAUDE_UTILITY_MODEL = "claude-haiku-4-5-20251001";
